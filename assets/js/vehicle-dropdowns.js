(function () {
  if (typeof window !== 'undefined' && window.initVehicleDropdowns) {
    return;
  }
  ...
  window.initVehicleDropdowns = function initVehicleDropdowns() {
